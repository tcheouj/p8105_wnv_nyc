...
# path <- "data/shapefiles/tl_2021_us_zcta520.shp"
# 
# zip_shp <- 
#   path |> 
#   st_read() |> 
#   filter(ZCTA5CE20 %in% all_zctas) |>  
#   janitor::clean_names() |> 
#   mutate(zip_code = as.double(zcta5ce20))
# 
# cases_by_zcta_shp <- 
#   left_join(cases_by_zcta, zip_shp, by = join_by("zip_code"))
# 
# anti_join(cases_by_zcta, cases_by_zcta_shp)

```

```{r maps of counts by zcta}
# cases_by_zcta_shp |> 
#   filter(year == 2021) |> 
