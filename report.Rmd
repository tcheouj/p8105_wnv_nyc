...
### Background and Aims
Climate change is worsening the transmission and spread of vector-borne diseases. Among these is West Nile Virus (WNV), a mosquito-borne disease that has recently become endemic to New York City. While approximately most WNV cases are asymptomatic or lead to mild flu-like symptoms, some lead to [serious complications](https://www.cdc.gov/west-nile-virus/hcp/clinical-signs/index.html) like neuroinvasive disease which is associated with significant morbidity and mortality. 
